...
date = 2014-08-31
categories = ["Writing"]
thumbnail = "new-beginnings/giphy.gif"
...
+++
![](new-beginnings/giphy.gif)

Hi there!

I've taken the time to update my website again. This time I've kept the theme the same (so hopefully you won't notice that too much has changed) but I've moved away from an [Angular JS](https://angularjs.org/) based site to a static one built using [Hexo](http://hexo.io/). This should make adding new writing and projects much easier!

I've gone through all of my old projects and cleaned them up and tidied everything up a bit. Have a look around!
