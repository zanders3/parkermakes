...
categories = ["Projects"]
thumbnail = "Wikitime/screen4.png"
...
![Famous Scottish Scientists](Wikitime/screen1.jpg)

Historical Event Extraction
---------------------------

![Extraction Overview](Wikitime/diagram1.png)
...
![Event Extraction and Indexing](Wikitime/diagram2.png)
...
![The Life of Christopher Columbus](Wikitime/screen2.jpg)
...
![Page Rank Algorithm](Wikitime/diagram3.png)
...
![Website Homepage](Wikitime/screen3.jpg)

So in conclusion it was a fun final year project for my degree which pushed my interests far beyond the graphics and game design which I had being doing in my free time up until that point. In case you missed the link above I highly recommend [checking out the demo](http://wikitime.herokuapp.com/) which uses the simple english wikipedia. If you are still interested in how the whole thing works, you can read [my project report](Wikitime/finalreport.pdf).

![Pixar](Wikitime/screen4.png)